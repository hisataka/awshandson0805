...
export class PipelineCdkStack extends Stack {
  constructor(scope: Construct, id: string, props: ConsumerProps) {
    ...
    const signerARNParameter = new ssm.StringParameter(this, 'SignerARNParam', {
      ...
      stringValue: 'arn:aws:signer:ap-northeast-1:354366286107:/signing-profiles/ecr_signing_profile',
    });
    ...
    pipeline.addStage({
        ...
        actions: [
          new codepipeline_actions.CodeStarConnectionsSourceAction({
            ...
            output: sourceOutput,
            branch: 'main',
            connectionArn: 'arn:aws:codeconnections:ap-northeast-1:354366286107:connection/e32d59d0-0e84-4a97-bc97-e2fbf17cbccc',
          }),
        ],
      });
